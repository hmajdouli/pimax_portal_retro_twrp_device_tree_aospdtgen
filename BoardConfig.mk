...
TARGET_KERNEL_SOURCE := kernel/pimax/qssi
...
BOARD_DTBOIMG_PARTITION_SIZE := 25175434
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 104857600
BOARD_SUPER_PARTITION_SIZE := 9126805504 # TODO: Fix hardcoded value
BOARD_SUPER_PARTITION_GROUPS := pimax_dynamic_partitions
BOARD_PIMAX_DYNAMIC_PARTITIONS_PARTITION_LIST := \
    product \
    system \
    odm \
    vendor
...
include vendor/pimax/qssi/BoardConfigVendor.mk
